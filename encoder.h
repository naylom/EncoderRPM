...
class Encoder
{
	...
	public:
		Encoder ( int16_t iPPR, pin_size_t aChannelPin, pin_size_t bChannelPin, uint8_t index );
		void	ProcessPulse ();
		int32_t GetReading ();
...
{
	public:
		int8_t	 AddEncoder ( int16_t iPPR, pin_size_t aChannelPin, pin_size_t bChannelPin );
